...
export interface IOrderItem {
    product?: mongoose.Types.ObjectId; // Optional for custom items
...
// Methods
OrderSchema.methods.updateStatus = async function (status: string, note?: string, updatedBy?: string): Promise<IOrder> {
    this.status = status;
