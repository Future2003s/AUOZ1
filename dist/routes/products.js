...
router.get("/featured", (0, compression_1.staticDataCache)(30), productController_1.getFeaturedProducts); // Public - No auth required - Cache for 30 seconds
...
router.get("/:id", (0, compression_1.staticDataCache)(30), productController_1.getProduct); // Cache individual products 30s (supports both ID and slug)
