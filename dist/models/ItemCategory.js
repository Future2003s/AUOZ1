...
const ItemCategorySchema = new mongoose_1.Schema({
    ...
    parentId: { type: mongoose_1.Schema.Types.ObjectId, ref: "ItemCategory", default: null },
...
exports.ItemCategory = mongoose_1.default.model("ItemCategory", ItemCategorySchema);
